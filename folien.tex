...
\frame[plain]{\justifying\fontsize{7pt}{8.4}\selectfont
  ...
  Reihe von Vorteilen mit sich: Da es keine Nebeneffekte wie
  ...
  Es gibt das Motto, dass, wenn Haskell-Code erst einmal kompiliert, er dann
...
\frame[t]{\frametitle{Imperative Sprachen}
  ...
  \begin{itemize}
    ...
    \item \textcolor{white}{keine} Nebeneffekte
  \end{itemize}
}
...
\frame[t,plain]{
  \begin{itemize}
    ...
    \item Die Ausführung von Aktionen muss man in Haskel \emph{explizit} angeben.
  \end{itemize}
}
...
\frame[t]{\frametitle{Arten von Aktionen}
  ...
  \begin{itemize}
    ...
    \item Writer (Logging)
    \item Listen für Nichtdeterminismus und Logikprogrammierung
...
\frame[t,plain]{
  \begin{itemize}
    \item Ein Wert vom Typ \texttt{State s a} ist eine Aktion,
          die einen Wert vom Typ \texttt{a} berechnet und als Nebeneffekt eine
...
\frame[t]{\frametitle{Paketarchiv Hackage}
  \vspace{-0.5em}%
  \begin{itemize}
    \item Entstehung 2007, mittlerweile $5000^+$ Pakete
