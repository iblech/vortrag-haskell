...
\frame[t]{\frametitle{Keine Nebeneffekte}
  ...
  \vspace{-2em}\setlength{\columnsep}{80pt}%
  \begin{multicols*}{2}
    \texttt{%
      \syncomment{\# Perl} \\
...
\frame[t]{\frametitle{Typerschließung}
  ...
  \texttt{%
    \ \\
    \visible<2>{%
      greet \synSym{::}\ \synType{String}\ -> \synType{String}%
    } \\
