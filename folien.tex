...
\frame[t]{\frametitle{Typen von Ein-/Ausgabe-Operationen}
  ...
  \begin{minipage}{11.3cm}\begin{itemize}
    \item \texttt{\synType{IO}\ \synType{Foo}} meint:
          IO-Aktion vom Typ \texttt{\synType{Foo}}
...
\frame[t]{\frametitle{Parser-Aktionen}
  ...
  Parser für Perl-Bezeichner (wie beispielsweise \texttt{\$foo} oder
  \texttt{@bar123}):
  \vfill
...
\frame[t]{\frametitle{Größere Anwendungen}
  \begin{itemize}
    ...
    \item Tiling Fenstermanager: xmonad
...
\appendix
\frame{
  \floatbox{-210}{200}{\includegraphics[scale=0.25]{images/present.png}}%
