...
\frame[t]{\frametitle{Typen von Aktionen}
  ...
  \begin{tabbing}
    ...
    \texttt{putStr}  \> \hatTyp \> \texttt{\synType{String}\ \synSym{->}\ \synType{IO}\ ()} \\
    \texttt{readFile} \> \hatTyp \> \texttt{\synType{FilePath}\ \synSym{->}\ \synType{IO}\ \synType{String}}
  \end{tabbing}
...
\frame[t]{\frametitle{QuickCheck (Forts.)}
  ...
  \begin{itemize}
    ...
    \item Instanzen von \texttt{\synType{Arbitrary}} nicht nur für
          primitive, sondern auch für zusammengesetzte Typen
  \end{itemize}
  \vfill
